...
const AddReview = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post('/reviews', { title, author, rating: Number(rating), reviewText });
        ...
        <div className="min-h-screen bg-gradient-to-b from-white to-gray-100">
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="text-center mb-8">
                    <h1 className="text-4xl font-extrabold text-gray-900 mb-4">Add New Review</h1>
                    <p className="text-lg text-gray-600">Share your thoughts about a book</p>
                </div>
